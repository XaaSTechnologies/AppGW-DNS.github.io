...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww28460\viewh13220\viewkind0
\pard\tx566\tx1133\tx1700\tx2267\tx2834\tx3401\tx3968\tx4535\tx5102\tx5669\tx6236\tx6803\pardirnatural\partightenfactor0

\f0\fs36 \cf0 # Script to create Application Gateway and Backend Pool Virtual Machines (VMs) - VM-01, VM-02, VM-03\
\
az group create \\\
--name RG-13-DNS \\\
--location westeurope\
...
az vm extension set \\\
  ...
  --vm-name VM-02 \\\
  --resource-group RG-13-DNS \\\
  --settings '\{"commandToExecute":"apt-get -y update && apt-get -y install apache2 && rm -rf /var/www/html && git clone https://github.com/XaaSTechnologies/AppGw-Images-Web-Server.github.io.git /var/www/html/images\'94\}\'92\
\
\
# NSG for VM-03\
az network nsg create \\\
...
az vm extension set \\\
  ...
  --vm-name VM-03 \\\
  --resource-group RG-13-DNS \\\
  --settings '\{"commandToExecute":"apt-get -y update && apt-get -y install apache2 && rm -rf /var/www/html && git clone https://github.com/XaaSTechnologies/AppGw-Video-Web-Server.github.io.git /var/www/html/video\'94\}\'92\
\
# Deploy Application Gateway\
\
\pard\tx566\tx1133\tx1700\tx2267\tx2834\tx3401\tx3968\tx4535\tx5102\tx5669\tx6236\tx6803\pardeftab720\partightenfactor0
\cf0 az network public-ip create \\\
  --resource-group RG-13-DNS \\\
  --name AppGW-PIP \\\
